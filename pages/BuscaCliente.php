...
if (!empty($_POST) ) {
    ...
    function getData($sql){
        global $conexao ;//we use connection already opened
        $query = mysqli_query($conexao, $sql) OR DIE ("Can't get Data from DB , check your SQL Query " );
        $data = array();
